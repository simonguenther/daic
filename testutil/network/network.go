...
import (
	...
	"github.com/strangelove-ventures/daic/app"
	"github.com/strangelove-ventures/daic/cmd"
	"github.com/strangelove-ventures/daic/testutil"
...
func DefaultConfig() network.Config {
	...
	return network.Config{
		...
		// Some changes are introduced to make the tests run as if daic is a standalone chain.
