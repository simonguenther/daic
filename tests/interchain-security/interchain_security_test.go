...
import (
	...
	appConsumer "github.com/strangelove-ventures/daic/app"
...
// NewCoordinator initializes Coordinator with interchain security dummy provider and daic consumer chain
